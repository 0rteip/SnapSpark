<form method="POST" class="row g-3 needs-validation :-<?php echo $_GET['action'] ?>" id="mod-new-form">
    ...
    <div class="col-md-6">
        ...
        <input type="text" class="form-control extra-validation" id="nome" name="nome" value="<?php echo $templateParams['accountInfo']['nome'] ?>" required>
        <div class="valid-feedback">
            Looks good!
        </div>
    ...
    <div class="col-md-6">
        ...
        <input type="text" class="form-control extra-validation" id="cognome" name="cognome" value="<?php echo $templateParams['accountInfo']['cognome'] ?>" required>
        <div class="valid-feedback">
            Looks good!
        </div>
        <div class="invalid-feedback">
    ...
    <div class="col-md-4">
        ...
        <input type="date" class="form-control  extra-validation" id="data_nascita" name="data_nascita" value="<?php echo $templateParams['accountInfo']['data_nascita'] ?>" required>
        <div class="invalid-feedback">
            Data obbligatoria.
        </div>
    </div>
    ...
    <div class="col-md-4">
        ...
        <input type="tel" class="form-control extra-validation" id="numero" name="numero" value="<?php echo $templateParams['accountInfo']['numero'] ?>" required>
        <div class="invalid-feedback">
            Invalid number
        </div>
    </div>
    <div class="mb-3">
        ...
        <textarea class="form-control extra-validation" id="biografia" rows="3" name="biografia"><?php echo $templateParams['accountInfo']['biografia'] ?></textarea>
    </div>
    ...
    <div class="col-12">
        <?php if ($_GET['action'] == "update_user") : ?>
            <button class="btn btn-primary col-md-auto col-12 text-center d-sm-grid mb-3 mb-md-0 me-md-2 d-md-inline" type="submit">Save</button>
            <button class="btn btn-primary col-md-auto col-12 text-center d-sm-grid mb-3 mb-md-0 me-md-2 d-md-inline" type="reset" id="reset-valid-bt">Cancel</button>
