...
<input class="form-control bg-info-subtle" name="search" type="search" placeholder="Search" aria-label="Search" onkeyup="followerSearch(this.value, 2,  '<?php print($templateParams['username']) ;?>' , '<?php print($templateParams['action']) ;?>' )">
